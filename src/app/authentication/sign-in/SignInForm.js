...
const SignInForm = () => {
    return (
        <form className='w-full md:w-1/2 bg-gray-50 flex flex-col justify-center space-y-3 items-center py-6 px-3 rounded-t-2xl md:rounded-l-2xl md:rounded-r-none'>
                ...
                <TransparentButton type='submit' customClass='rounded-3xl px-6 py-3 text-white border-none bg-purple-500 w-2/3 hover:text-black'>SIGN IN</TransparentButton>
            </form>
    );
};
